...
const steps = [
  ...
  },
  {
    ...
    text: "Добавьте готовый профиль через расширение ThreadsGo. Система проверит доступ и покажет, можно ли публиковать.",
    action: "Откройте «Аккаунты», войдите в нужный профиль Threads в браузере и подключите его в один клик.",
